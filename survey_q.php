...
$counts_question6 = getCounts($conn, 'question6');
...
<body>
                    ...
                    <table class="table table-striped table-bordered" id="example6" width="100%" cellspacing="0">
                        <thead class="table-dark">
                            <tr class="tdh">
                                ...
                                <th>Solución</th>
                                <th>Desempeño</th>
                                <th>Frecuencia y desempeño</th>
                                <th>Recomendación de SVM</th>
                                <th>Observaciones</th>
                            </tr>
                        </thead>
                        <tbody>
    ...
    <script>
        ...
        const chartQuestion6 = new Chart(ctx6, {
            type: 'bar',
            data: generateChartData(data.question5),
            options: {
                scales: {
