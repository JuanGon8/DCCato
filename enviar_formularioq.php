...
try {
    ...
    $mail_corporativo->addAddress($correo_corporativo, $nombre_cliente); // Usar el correo corporativo proporcionado en el formulario y el nombre del remitente
    ...
    $sql = "INSERT INTO alta_quejas (tipo_qs, nombre_cliente, ubicacion, tel, correo_corporativo, descripcion, tipo_servicio, departamento, departamento_receptor, prioridad, fecha)
            VALUES ('$tipo_qs','$nombre_cliente', '$ubicacion', '$tel', '$correo_corporativo', '$descripcion', '$tipo_servicio', '$departamento', '$departamento_receptor', '$prioridad', '$fecha')";
