...
$sql = "SELECT codigo, fecha_alta, ap_pat, ap_mat, nombre, ubicacion, salario_diario, sbc, departamento, turno, nss, rfc, curp, sexo, fecha_nac, puesto, entidad, cp, estado_civil, e_banco, n_ecuenta, suc_epago, imss_pat, tipo_contrato, base_cot, estatus_emp, sindicalizado, tipo_reg, tipo_prest, fecha_reingreso, fecha_baja  FROM reclutamiento WHERE codigo BETWEEN '$cod1' AND '$cod2'";
