                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Crear queja</h1>
                                ...
                                <form action="enviar_formulario.php" method="POST" enctype="multipart/form-data" id="formcrearreporte">
                                    <table class="table">
                                        <tr>
                                            <td>
                                                <div class="form-group mb-3">
                                                    <label for="tipo_qs">Tipo</label>
                                                    <select class="form-select" name="tipo_qs" id="tipo_qs" required>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group mb-3">
                                                    <label for="correo_corporativo">Correo electrónico</label>
                                            ...
                                            <td>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" name="tipo_servicio" id="tipo_servicio" required>
                                                        <option disabled selected value="">Selecciona el tipo</option>
                                                        <option value="Queja">Limpieza</option>
                                            ...
                                            <td>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select" name="departamento_receptor" id="departamento_receptor" required>
                                                        ...
                                                        <option value="gerenciacalidad@gruposvm.com">Gerencia calidad</option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#formcrearreporte').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'enviar_formularioq.php', // Ruta a tu script PHP
