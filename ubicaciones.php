                ...
                <tr>
                    <td width="25%" valign="top"> <!-- Esto hace que la celda ocupe la mitad de la tabla -->
                        <form method="POST" action="guardar_ubi.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-11">
                                    <label for="ubicaciont">Ubicación <i class="fa-solid fa-circle-exclamation" title="Este campo solo admite letras mayúsculas"></i></label>
                                    <input class="form-control inputwidth" type="text" name="ubicaciont" required oninput="this.value = this.value.toUpperCase()">
                                </div>
                            </div>
                            <br>
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="update_u.php" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col">
                                                                            <label for="ubicaciont">Departamento</label>
                                                                            <input class="form-control inputwidth" type="text" name="ubicaciont" value="<?php echo $row['ubicaciont']; ?>">
                                                                        </div>
